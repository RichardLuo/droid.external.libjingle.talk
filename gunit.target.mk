...
INCS_Debug := \
	...
	-Ithird_party/gtest \
	-I/home/richard/android-sdk/android-ndk-r8d/platforms/android-9/arch-arm/usr/include
...
OBJS := \
	$(obj).target/$(TARGET)/third_party/gtest/src/gtest-all.o
...
$(obj).target/talk/libgunit.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/talk/libgunit.a: LIBS := $(LIBS)
$(obj).target/talk/libgunit.a: TOOLSET := $(TOOLSET)
$(obj).target/talk/libgunit.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/talk/libgunit.a
# Add target alias
.PHONY: gunit
gunit: $(obj).target/talk/libgunit.a
...
# Add target alias
.PHONY: gunit
gunit: $(builddir)/libgunit.a

# Copy this to the static library output path.
$(builddir)/libgunit.a: TOOLSET := $(TOOLSET)
$(builddir)/libgunit.a: $(obj).target/talk/libgunit.a FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/libgunit.a
# Short alias for building this static library.
.PHONY: libgunit.a
libgunit.a: $(obj).target/talk/libgunit.a $(builddir)/libgunit.a

# Add static library to "all" target.
.PHONY: all
all: $(builddir)/libgunit.a

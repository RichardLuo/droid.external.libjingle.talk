...
OBJS := \
	$(obj).target/$(TARGET)/talk/examples/peerconnection/server/data_socket.o \
	$(obj).target/$(TARGET)/talk/examples/peerconnection/server/main.o \
	$(obj).target/$(TARGET)/talk/examples/peerconnection/server/peer_channel.o \
	$(obj).target/$(TARGET)/talk/examples/peerconnection/server/utils.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(builddir)/libjingle.a $(builddir)/libexpat.a $(builddir)/libjsoncpp.a $(builddir)/libopenssl.a $(obj).target/talk/libjingle.a $(obj).target/third_party/expat/libexpat.a $(obj).target/third_party/jsoncpp/libjsoncpp.a $(obj).target/third_party/openssl/libopenssl.a
...
$(builddir)/peerconnection_server: LD_INPUTS := $(OBJS) $(obj).target/talk/libjingle.a $(obj).target/third_party/expat/libexpat.a $(obj).target/third_party/jsoncpp/libjsoncpp.a $(obj).target/third_party/openssl/libopenssl.a
$(builddir)/peerconnection_server: TOOLSET := $(TOOLSET)
$(builddir)/peerconnection_server: $(OBJS) $(obj).target/talk/libjingle.a $(obj).target/third_party/expat/libexpat.a $(obj).target/third_party/jsoncpp/libjsoncpp.a $(obj).target/third_party/openssl/libopenssl.a FORCE_DO_CMD
	$(call do_cmd,link)

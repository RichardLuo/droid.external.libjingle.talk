...
OBJS := \
	$(obj).target/$(TARGET)/talk/xmpp/jingleinfotask.o
...
$(obj).target/talk/libjingle_xmpphelp.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/talk/libjingle_xmpphelp.a: LIBS := $(LIBS)
$(obj).target/talk/libjingle_xmpphelp.a: TOOLSET := $(TOOLSET)
$(obj).target/talk/libjingle_xmpphelp.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)

all_deps += $(obj).target/talk/libjingle_xmpphelp.a
# Add target alias
.PHONY: libjingle_xmpphelp
libjingle_xmpphelp: $(obj).target/talk/libjingle_xmpphelp.a

# Add target alias to "all" target.
.PHONY: all
all: libjingle_xmpphelp

# Add target alias
.PHONY: libjingle_xmpphelp
libjingle_xmpphelp: $(builddir)/libjingle_xmpphelp.a

# Copy this to the static library output path.
$(builddir)/libjingle_xmpphelp.a: TOOLSET := $(TOOLSET)
$(builddir)/libjingle_xmpphelp.a: $(obj).target/talk/libjingle_xmpphelp.a FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/libjingle_xmpphelp.a
# Short alias for building this static library.
.PHONY: libjingle_xmpphelp.a
libjingle_xmpphelp.a: $(obj).target/talk/libjingle_xmpphelp.a $(builddir)/libjingle_xmpphelp.a

# Add static library to "all" target.
.PHONY: all
all: $(builddir)/libjingle_xmpphelp.a
